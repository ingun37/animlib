...
animlib.so : animlib.o
	g++ -shared -m64 -O3 -pthread -pipe -D_BOOL -DLINUX -DREQUIRE_IOSTREAM -mtune=pentium4 -Wno-deprecated -fno-gnu-keywords -Wl -Bsymbolic -shared -o animlib.so animlib.o -L/Applications/Autodesk/maya2014/Maya.app/Contents/MacOS -lOpenMaya -lOpenMayaAnim -lFoundation
